...
const intakeCases = [
  ...
  { name: 'bateria-sin-moq', message: 'Batería recargable de ion litio 18650 para pack electrónico, origen China, precio proveedor USD 2.10, peso embalado 0.05 kg por unidad.', expect: { status: 'needs_input', missingIncludes: 'volumen embalado por unidad' } },
