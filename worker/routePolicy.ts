...
export const API_ROUTE_POLICIES: readonly RoutePolicy[] = [
  ...
  },
  {
    ...
    costRisk: 'low',
    externalProviders: [],
    notes: 'Owner-scoped subscription status. Browser-controlled plan/status fields are never entitlement authority.',
  },
  {
    id: 'billing-checkout',
    ...
    targetMetered: false,
    costRisk: 'medium',
    externalProviders: ['Mercado Pago'],
    notes: 'Creates an idempotent provider subscription from a server-owned plan mapping and server-owned payer email. Redirect success never grants entitlement.',
  },
  {
    ...
    costRisk: 'medium',
    externalProviders: ['Mercado Pago'],
    notes: 'Owner-scoped server-to-server reconciliation. Current provider state is authoritative.',
  },
  {
    id: 'billing-cancel',
    ...
    costRisk: 'medium',
    externalProviders: ['Mercado Pago'],
    notes: 'Owner-scoped cancellation. Local entitlement is updated only after provider cancellation is fetched and verified.',
  },
  {
    id: 'billing-mercadopago-webhook',
    path: '/api/billing/webhook/mercadopago',
    methods: ['POST'],
    ...
    costRisk: 'medium',
    externalProviders: ['Mercado Pago'],
    notes: 'Signed provider webhook. Signature only authorizes reconciliation; webhook body status/user data never grants entitlement.',
  },
  {
    id: 'digest-runtime',
