...
describe('Alibaba high-signal public corroboration', () => {
  it('derives the live 100m-watch style query from the mechanical-watch title', () => {
  ...
  it('prioritizes Alibaba countrysearch for high-signal routes', () => {
  ...
  it('recovers exact-id watch commerce facts from the high-signal route', async () => {
  ...
  it('does not accept a similarly named watch with a different product id', async () => {
