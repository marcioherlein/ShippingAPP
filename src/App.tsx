...
export default function App() {
  ...
  return <main>
    <header className="topbar"><a className="brand" href="#">Shipping<span>APP</span></a><span className="mvp-badge">MVP 0.6</span></header>
    <UrlAnalyzer onAnalysis={handleAnalysis} analysis={analysis} />
    {analysis && <MarketEvidence analysis={analysis} />}
    {analysis && economicsReady && <>
      <div className="analysis-banner"><b>Estimación instantánea.</b> Precio local basado en comparables publicados; NCM, derecho, origen preferencial, intervenciones y requisitos técnicos permanecen sujetos a verificación.</div>
    ...
    {!analysis && <section className="value-strip"><div><b>01</b><span>Producto y MOQ</span><p>Extraemos lo visible de la publicación.</p></div><div><b>02</b><span>Clasificación</span><p>Asignamos NCM sólo para categorías soportadas.</p></div><div><b>03</b><span>Mercado y logística</span><p>Comparables robustos + base cobrable realista.</p></div><div><b>04</b><span>Readiness regulatorio</span><p>Perfil, SICNEA, declaración, VUCE, RT y rotulado.</p></div></section>}
  </main>
}
