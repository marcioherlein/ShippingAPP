...
export default function App() {
  ...
  const regulatoryChecks = useMemo(() => analysis ? buildRegulatoryChecksV4(analysis, client) : [], [analysis, client])
  ...
  return <main>
    ...
    {!analysis && <section className="value-strip"><div><b>01</b><span>Producto y MOQ</span><p>Extraemos lo visible de la publicación.</p></div><div><b>02</b><span>Clasificación</span><p>Asignamos NCM sólo para categorías soportadas.</p></div><div><b>03</b><span>Mercado y logística</span><p>Comparables robustos + base cobrable realista.</p></div><div><b>04</b><span>Readiness regulatorio</span><p>Screening de producto + checklist del importador.</p></div></section>}
  </main>
}
