...
export default function App() {
  ...
  return <main>
    <header className="topbar"><a className="brand" href="#">Shipping<span>APP</span></a><span className="mvp-badge">MVP 0.4</span></header>
    <UrlAnalyzer onAnalysis={handleAnalysis} analysis={analysis} />
    {analysis && <MarketEvidence analysis={analysis} />}
    {analysis && economicsReady && <>
      <div className="analysis-banner"><b>Estimación instantánea.</b> Precio local basado en comparables publicados; NCM, derecho, origen preferencial e intervenciones permanecen sujetos a verificación.</div>
    ...
    {!analysis && <section className="value-strip"><div><b>01</b><span>Producto y MOQ</span><p>Extraemos lo visible de la publicación.</p></div><div><b>02</b><span>Clasificación</span><p>Asignamos NCM sólo para categorías soportadas.</p></div><div><b>03</b><span>Mercado argentino</span><p>Filtramos comparables y usamos percentiles robustos.</p></div><div><b>04</b><span>Readiness regulatorio</span><p>Checklist e intervenciones a verificar.</p></div></section>}
  </main>
}
