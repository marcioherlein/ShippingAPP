...
export default function LogisticsPanel({ inputs, setInputs }: Props) {
  return (
    <section className="panel">
      ...
      <p className="assumption-note">Aéreo: se cobra el mayor entre peso real y volumétrico. LCL: se modela W/M como el mayor entre CBM y toneladas métricas. Los coeficientes y cargos deben reemplazarse por la cotización/rate sheet vigente del carrier.</p>
    </section>
  )
}
